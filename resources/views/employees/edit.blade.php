...
<div>
    <!-- Page Header -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Edit Employee</h1>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select name="role" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-600" required>
                                ...
                                <option value="admin" {{ old('role', $employee->user->role ?? 'employee') == 'admin' ? 'selected' : '' }}>Admin</option>
                                <option value="head_department" {{ old('role', $employee->user->role ?? 'employee') == 'head_department' ? 'selected' : '' }}>Head of Department</option>
                                <option value="accountant" {{ old('role', $employee->user->role ?? 'employee') == 'accountant' ? 'selected' : '' }}>Accountant</option>
                                <option value="team_leader" {{ old('role', $employee->user->role ?? 'employee') == 'team_leader' ? 'selected' : '' }}>Team Leader</option>
